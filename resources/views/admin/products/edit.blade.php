...
@section('content')
    ...
    @foreach($product->photos as $photo)
        <div class="col-4 text-center mx-auto my-auto" style="height: 300px;">
        <img src="{{asset('storage/' . $photo->image)}}" class="img-fluid img-responsive img-thumbnail" style="width: 100%; height:100%;">
